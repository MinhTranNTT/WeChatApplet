<template>
	<view>
		<canvas :canvas-id="CanvasID" hidpi :style="{ width: canvasW + 'px', height: canvasH + 'px' }"></canvas>
	</view>
</template>
...
export default {
	...
	methods: {
		async OnCanvas() {
			...
			_this.ctx.lineTo(_strlineW + _this.ctx.measureText(200), _strHeight - uni.upx2px(10)); //终点
			_this.ctx.stroke();
			//设置价格 end
